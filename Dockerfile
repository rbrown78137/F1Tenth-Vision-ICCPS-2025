...
RUN /bin/bash -c "source /opt/ros/noetic/setup.bash && cd home && mkdir catkin_ws && cd catkin_ws && mkdir src && cd src && git clone https://github.com/rbrown78137/F1Tenth-Verification-ICCPS-2025.git && git clone https://github.com/rbrown78137/F1Tenth-Simulator-ICCPS-2025.git && git clone https://github.com/rbrown78137/F1Tenth-Vision-ICCPS-2025.git && cd F1Tenth-Vision-ICCPS-2025 && cd pose_detection && cd saved_models &&  wget -O pose.pt 'https://ww
w.dropbox.com/scl/fi/dvqgf611zsafh4oopvsg8/pose.pt?rlkey=80xcbel3blj041ap8zjou2r9a&st=l8vt6nln&dl=1' && cd .. && cd .. && cd pose_detection && cd saved_models && wget -O yolo.pt 'https://www.dropbox.com/scl/fi/gb6cvw9srt03teo3in6wj/yolo.pt?rlkey=68vvabned8zd08kgi6zut2vl5&st=3snnbocb&dl=1' && cd .. && cd .. && cd .. && catkin_make"
